/*
  ...
  - You are about to drop the column `profile` on the `Market` table. All the data in the column will be lost.
  - You are about to drop the column `profile` on the `MarketCategory` table. All the data in the column will be lost.
...
INSERT INTO "new_Market" ("createdAt", "id", "marketCategoryId", "name", "ruleBook", "rules", "updatedAt") SELECT "createdAt", "id", "marketCategoryId", "name", "ruleBook", "rules", "updatedAt" FROM "Market";
DROP TABLE "Market";
