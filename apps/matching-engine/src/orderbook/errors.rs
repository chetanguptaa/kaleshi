...
mod tests {
    ...
    fn test_error_type_codes_and_messages() {
        let cases = vec![
            ...
            (
                ErrorType::InvalidPriceOrQuantity,
                1103,
            ...
            (
                ErrorType::InsufficientQuantity,
                1201,
                "Insufficient quantity to calculate price",
            ),
            (
                ErrorType::InvalidPriceLevel,
                1202,
                "Invalid order price level",
            ),
        ];
    ...
    fn test_error_type_code_and_message() {
        ...
        assert_eq!(
            ErrorType::InvalidPriceLevel.message(),
            "Invalid order price level"
        );
    }
    ...
    fn test_default_message_for_code() {
        ...
        assert_eq!(
            default_message_for_code(1101),
            ErrorType::InvalidQuantity.message()
        );
        assert_eq!(
            default_message_for_code(1102),
            ErrorType::InvalidPrice.message()
        );
        assert_eq!(
            default_message_for_code(1103),
            ErrorType::InvalidPriceOrQuantity.message()
        );
        assert_eq!(
            default_message_for_code(1104),
            ErrorType::OrderPostOnly.message()
        );
        assert_eq!(
            default_message_for_code(1105),
            ErrorType::OrderIOC.message()
        );
        assert_eq!(
            default_message_for_code(1106),
            ErrorType::OrderFOK.message()
        );
        assert_eq!(
            default_message_for_code(1109),
            ErrorType::OrderAlredyExists.message()
        );
        assert_eq!(
            default_message_for_code(1110),
            ErrorType::OrderNotFound.message()
        );
        assert_eq!(
            default_message_for_code(1200),
            ErrorType::InsufficientQuantity.message()
        );
        assert_eq!(
            default_message_for_code(1201),
            ErrorType::InvalidPriceLevel.message()
        );
    }
