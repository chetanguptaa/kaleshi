...
INSERT INTO "new_Order" ("accountId", "createdAt", "id", "marketId", "orderType", "originalQuantity", "outcomeId", "price", "quantity", "side", "status", "timeInForce", "updatedAt") SELECT "accountId", "createdAt", "id", "marketId", "orderType", "originalQuantity", "outcomeId", "price", "quantity", "side", "status", "timeInForce", "updatedAt" FROM "Order";
DROP TABLE "Order";
