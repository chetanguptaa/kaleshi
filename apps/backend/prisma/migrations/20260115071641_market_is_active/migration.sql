...
INSERT INTO "new_Market" ("createdAt", "endsAt", "id", "information", "marketCategoryId", "name", "ruleBook", "rules", "startsAt", "updatedAt") SELECT "createdAt", "endsAt", "id", "information", "marketCategoryId", "name", "ruleBook", "rules", "startsAt", "updatedAt" FROM "Market";
DROP TABLE "Market";
